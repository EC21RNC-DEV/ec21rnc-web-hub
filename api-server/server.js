...
const BUILTIN_SERVICES = [
  ...
  { path: "/aif-newsletter", upstream: "app_newsletter", port: 8503 },
  { path: "/emerics-inspection", upstream: "emerics-inspection-app", port: 8542 },
  ...
  { path: "/issue-clustering", upstream: "app_issue_curation", port: 8591 },
  ...
  { path: "/pdf-converter", upstream: "app_pdf_to_html", port: 8593 },
